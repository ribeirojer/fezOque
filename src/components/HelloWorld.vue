...
-->
  <div class="greetings">
    <header
      ...
      class="w-full flex items-center justify-between bg-white p-3 md:p-5 lg:p-0"
    >
      <a href="index.html">
        <img src="assets/logo2.png" alt="logo" class="md:ml-4 w-48" />
      </a>
      <div>
        <button id="navbarToggler"
          class="block lg:hidden focus:ring-2 ring-primary px-2 py-1 rounded-lg"
        >
          <span
            class="relative w-[30px] h-[2px] my-[6px] block bg-blue-600"
          ></span>
          <span
            class="relative w-[30px] h-[2px] my-[6px] block bg-blue-600"
          ></span>
        ...
        <nav>
          id="navbarCollapse" class="bg-white absolute py-5 px-6 shadow
          rounded-lg max-w-[140px] w-full lg:max-w-full lg:w-full right-4
          top-[77px] lg:block lg:static lg:shadow-none">
    ...
    <main
      class="flex justify-end flex-col-reverse pt-4 lg:pt-0 items-center bg-[#0f0e5e] h-screen bg-[url('assets/bbblurry.svg')] bg-no-repeat bg-cover bg-center lg:h-[88vh] lg:flex-row-reverse lg:justify-evenly lg:max-w-[100vw]"
    >
